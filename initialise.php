 ...
 */
  ...
  if(isset($_POST['host'])) {
    ...
    mysqli_query($con,"CREATE DATABASE $database") or die('Error creating database' . mysqli_connect_error());
  ...
  PRIMARY KEY (`uid`)
  )") or die('Error creating table users;' . mysqli_connect_error());

  mysqli_query($con,"CREATE TABLE IF NOT EXISTS `offers` (
  ...
  `description` text,
  PRIMARY KEY (`id`))") or die('Error creating table "offers".' . mysqli_connect_error());
  ...
  mysqli_query($con,"CREATE TABLE IF NOT EXISTS `notifications` (
    ...
    `cid` int(11) NOT NULL,
    PRIMARY KEY(`slno`))") or die('Error creating table "notifications".' . mysqli_connect_error());
  ...
  mysqli_query($con,"CREATE TABLE IF NOT EXISTS `comments` (
    ...
    `cid` int(11) NOT NULL,
    PRIMARY KEY(`slno`))") or die('Error creating table "comments".' . mysqli_connect_error());

  mysqli_query($con,"CREATE TABLE IF NOT EXISTS `route` (
    `routeid` int(11) NOT NULL AUTO_INCREMENT,
    `cid` int(11) NOT NULL,
    `place` varchar(250) NOT NULL,
    `serialno` int(11) NOT NULL,
    PRIMARY KEY (`routeid`)
    )") or die('Error creating table "route".' . mysqli_connect_error());
...
<html lang="en">
  ...
  <body>
    ...
    <div id="footer">
      <div class="container">
        <p class="muted credit">Built with love by @20124043 @20124036 @20124030</p>
      </div>
    </div>
